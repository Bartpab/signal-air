defmodule SignalAirWeb.Signalement.NuisanceOlfactiveControllerTest do
    ...
    test "créer nouvelle nuisance olfactive", %{conn: conn} do
      ...
      assert redirected_to(conn) == Routes.live_path(conn, SignalAirWeb.Surveillance.CitoyenLive)
