defmodule SignalNuisance.Commentaire.ListeLive do
    ...
    def handle_event("basculer_afficher_formulaire", _, socket) do
      {:noreply, socket |> assign(:afficher_formulaire, !socket.assigns.afficher_formulaire) |> assign(:afficher_commentaires, true)}
    end
    ...
    def render(assigns) do
      ...
      <div class="container-fluid">
        <nav class="nav">
          <a class="nav-item nav-link" phx-click="basculer_affichage_commentaires">
          ...
          <a class="nav-item nav-link" phx-click="basculer_afficher_formulaire"><i class="bi bi-reply"></i> Répondre</a>
        </nav>
