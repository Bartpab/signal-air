defmodule SignalNuisance.Signalement.Commun do
    defstruct id: nil, stype: nil, nb_vues: 0, lat: nil, long: nil, signaler_par_id: nil, cree_le: Timex.now()
    ...
    def base, do: [id: nil, nb_vues: 0, lat: nil, long: nil, signaler_par_id: nil, cree_le: Timex.now()]
