defmodule SignalAir.Signalement.Commun do
    ...
    defstruct id: nil, stype: nil, lat: nil, long: nil, signaler_par_id: nil, cree_le: DateTime.now!("Etc/UTC")
    ...
    def base, do: [id: nil, lat: nil, long: nil, signaler_par_id: nil, cree_le: DateTime.now!("Etc/UTC")]
